import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Input, Label, Text } from '@/components/ui';
  ...
  return (
    <View className="gap-6">
      <Card className="border-border/0 shadow-none sm:border-border sm:shadow-sm sm:shadow-black/5">
        <CardHeader>
          <CardTitle className="text-center text-xl sm:text-left">Återställ lösenord</CardTitle>
          <CardDescription className="text-center sm:text-left">
            Ange koden som skickades till din e-post och välj ett nytt lösenord.
          </CardDescription>
        </CardHeader>
